...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x7E6ab54Ff305acC8A80B8436102A46442a693F63;
...
contract FamilyToken is Context, IERC20, Ownable {
    ...
    address public charityWallet = 0x4Aabc99A5816C5dDfd422a4aF3e361C097041323;
    address public marketingWallet = 0x11FD5857eDFa84f401887548d5f4D698A4D31808;
    address public arbitrageWallet = 0xcF96211516e8Fcc8c03672a2B18Ed37378547558;
    ...
    constructor() public {
        _rOwned[0x7E6ab54Ff305acC8A80B8436102A46442a693F63] = _rTotal;
        BUSD = IERC20(_busd);
        ...
        emit Transfer(
            address(0),
            0x7E6ab54Ff305acC8A80B8436102A46442a693F63,
            _tTotal
        );
    }
